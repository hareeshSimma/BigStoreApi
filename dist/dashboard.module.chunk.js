    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.dashboardservice.getProducts().subscribe(function (res) {
            ...
            (res).forEach(function (element) {
                _this.imgUrl = "http://localhost:3000/images/";
                // console.log()     
            });
        });
    };
